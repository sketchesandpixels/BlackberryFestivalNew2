  ...
  return (
    <div className="fixed top-4 left-0 right-0 z-50 flex justify-center w-full px-4 pointer-events-none">
      <motion.nav
        ...
        className="backdrop-blur-xl bg-white/95 border border-white rounded- px-5 py-3 flex items-center justify-between w-full max-w-5xl pointer-events-auto transition-all shadow-[0_8px_30px_rgb(0,0,0,0.04)]"
      >
        <div className="flex items-center gap-3 cursor-pointer group px-2" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>
          ...
          <div className="flex flex-col leading-none relative">
            <span className="text- font-black uppercase tracking-[0.3em] absolute -top-1.5 -right-1" style={{ color: COLORS.crimson }}>Inaugural</span>
        ...
        <div className="flex items-center gap-2 sm:gap-6">
          ...
          <button
            ...
            className="rounded-full font-black px-6 py-5 text-xs uppercase tracking-widest hover:scale-105 transition-transform shadow-xl cursor-pointer"
