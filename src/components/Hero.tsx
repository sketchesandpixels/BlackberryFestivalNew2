    ...
    <section className="relative min-h-[100dvh] flex flex-col justify-center overflow-hidden bg-white">
      ...
      <div className="container mx-auto px-4 relative z-10 pt-20">
        <div className="flex flex-col items-center text-center">
          ...
          >
            Where culture meets the harvest. Join the <span className="font-bold text-slate-900 underline decoration-yellow-400 decoration-4 underline-offset-4"> Blackberry Festival of Prairie View, Texas </span> for a day of music, heritage, and the sweetest berries of the season.
          </motion.p>
